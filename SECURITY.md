...
same macOS user. Configured MCP clients can read history and queue text through
the exposed tools. Accessibility access is needed to dispatch paste events.

Release binaries are ad-hoc signed and are not Developer ID signed or notarized.
