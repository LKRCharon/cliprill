...
extension String {
	...
	*/
	var localized: String {
		// Cliprill: use the signed app's Resources directory before SwiftPM's CLI fallback.
		let packaged = Bundle.main.resourceURL.flatMap {
			Bundle(url: $0.appendingPathComponent("KeyboardShortcuts_KeyboardShortcuts.bundle"))
		}
		return NSLocalizedString(self, bundle: packaged ?? .module, comment: self)
	}
}
