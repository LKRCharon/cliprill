...
final class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    func applicationDidFinishLaunching(_ notification: Notification) {
        UserDefaults.standard.register(defaults: ["captureEnabled": true, "historyCapacity": 500, "retentionDays": 30, "captureImages": true, "captureSpeed": "balanced", "showSourceApps": false, "pasteMovesToTop": true, "previewDelay": 0.5, "automaticPreview": true, "boardPreviews": true, "autoDeleteEmptyQueues": true])
        do {
